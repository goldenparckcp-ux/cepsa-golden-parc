...
- Name: security.spec.ts >> Security & Role Redirection E2E Flows >> 2. Staff roles are correctly isolated and locked out of unauthorized pages
- Location: tests\security.spec.ts:82:9
...
=========================== logs ===========================
waiting for navigation to "**/staff/hotel" until "load"
============================================================
```
