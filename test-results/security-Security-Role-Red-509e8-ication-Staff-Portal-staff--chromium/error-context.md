...
- Name: security.spec.ts >> Security & Role Redirection E2E Flows >> 4. PIN Code Portal verification (Staff Portal /staff)
- Location: tests\security.spec.ts:164:9
...
Call log:
  - waiting for locator('text=Code PIN incorrect. Veuillez contacter l\'administrateur.') to be visible
...
- generic [ref=e3]:
  - img [ref=e5]
  - heading "Portail Employés (Staff)" [level=2] [ref=e7]
  - paragraph [ref=e8]: Saisissez votre code PIN pour accéder à votre interface
  - generic [ref=e14]:
    ...
    - button "7" [ref=e21] [cursor=pointer]
    - button "8" [ref=e22] [cursor=pointer]
    - button "9" [ref=e23] [cursor=pointer]
    - button "EFFACER" [ref=e24] [cursor=pointer]
    - button "0" [active] [ref=e25] [cursor=pointer]
