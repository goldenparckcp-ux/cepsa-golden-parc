...
const OPTIONS = [
    { id: "diag", label: "Diagnostic Auto", price: 100, duration: "30 min", slots: 1, icon: <Search className="w-5 h-5 text-red-400" /> },
    { id: "vidange", label: "Vidange Huile (Simple)", price: 150, duration: "30 min", slots: 1, icon: <Droplets className="w-5 h-5 text-amber-500" /> },
    { id: "vidange_complet", label: "Vidange + Filtres", price: 300, duration: "1h", slots: 2, icon: <Droplets className="w-5 h-5 text-red-500" /> },
