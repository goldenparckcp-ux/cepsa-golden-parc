...
export default function AdminHotelReservationsPage() {
    ...
    // Helper to see if a visual room is currently occupied
        ...
        <div className="space-y-6 pb-12 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-black text-white">Gestion de l'Hôtel</h1>
                        <p className="text-xs text-gray-400 font-medium">Suivi des séjours (Nuits/Siestes) et attribution des chambres</p>
                    </div>
                </div>
                                ...
                                {occupancy ? (
                                    <div className="mt-4">
                                        <div className="text-[10px] text-red-400 font-bold flex items-center gap-1.5">
                                            {occupancy.booking_type === "night" ? <Moon className="w-3 h-3 text-amber-500 shrink-0" /> : <Sun className="w-3 h-3 text-orange-500 shrink-0" />}
                                            <span>Occupée</span>
                                        </div>
