...
import { Car, X, Plus, Utensils, Zap } from "lucide-react";
        ...
        <div className="fixed inset-0 bg-[#0B0F19] z-[100] text-white flex flex-col font-sans select-none relative overflow-hidden">
            ...
            <div className="h-24 bg-[#0B0F19]/80 backdrop-blur-md border-b border-white/5 flex items-center justify-between px-6 shrink-0">
                <div className="flex items-center gap-4 text-red-500">
                    ...
                    <span className="text-2xl font-black tracking-widest uppercase">{tLocal.driveMode}</span>
                </div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex-1 text-left flex flex-col justify-center">
                                        <h3 className="text-2xl font-black uppercase tracking-tight line-clamp-2">{itemName}</h3>
                                ...
                                items.map((item, idx) => {
                                    ...
                                    return (
                                        <div key={idx} className="bg-[#111827]/40 backdrop-blur-md p-6 rounded-[2rem] border border-white/5 flex justify-between items-center text-3xl font-black">
                                            <span className="truncate pr-4 uppercase tracking-tight">{itemName}</span>
            ...
            {/* Bottom Large Nav */}
            <div className="h-32 bg-[#0B0F19]/80 backdrop-blur-md border-t border-white/5 flex p-4 gap-4 shrink-0 font-sans">
                <button 
                ...
                >
                    <Utensils className="w-10 h-10" /> {tLocal.menu}
                </button>
                <button 
                ...
                >
                    <Zap className="w-10 h-10" /> {tLocal.cart}
                    {items.length > 0 && (
