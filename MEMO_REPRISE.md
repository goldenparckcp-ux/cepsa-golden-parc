...
2.  **Mécanique (Siyana)** :
    *   On n'a pas encore testé la réservation ni l'affichage dans le profil pour ce service.
...
**Message pour l'IA de demain :**
Commence par demander à l'utilisateur s'il veut vérifier l'affichage de la **Piscine** ou du **Lavage** dans le profil. La base de données est solide, concentre-toi sur l'UI du profil (`app/profile/page.tsx`).
